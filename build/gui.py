...
canvas.create_text(
    ...
    426.0,
    anchor="nw",
    text="Enter max GAS amount to use",
    fill="#CBCFD4",
    font=("Montserrat Regular", 10 * -1)
)
...
canvas.create_text(
    ...
    493.0,
    anchor="nw",
    text="0x10ED43C718714eb63d5aA57B78B54704E256024E",
    fill="#CBCFD4",
    font=("Montserrat Regular", 14 * -1)
)
...
entry_2.insert(0,"0.05")
entry_3.insert(0,"1.5")
entry_4.insert(0,"300000")
entry_6.insert(0,"https://bsc-dataseed.binance.org/")
entry_7.insert(0,"0x10ED43C718714eb63d5aA57B78B54704E256024E")
